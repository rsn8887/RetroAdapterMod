...
PROGMEM char usbHidReportDescriptorIgnore1P[] = {
	0x05,0x01,		//Usage_Page (Generic Desktop)
...
PROGMEM char usbHidReportDescriptorIgnoreWheel[] = {
	0x05,0x01,		//Usage_Page (Generic Desktop)
	0x09,0x04,		//Usage (Joystick)
...
//Analog Buttons
	...
	0x09, 0xC4,                    //   USAGE (Brake) // Brake and Accel for android compatibility
	0x09, 0xC5,                    //   USAGE (Accel)
	0x15, 0x00,						//Logical_Minimum (0)
	0x26,0xFF, 0x00,				//Logical Maximum (255))
    0x75, 0x08,                    //   REPORT_SIZE (8)
    0x95, 0x02,                    //   REPORT_COUNT (2)
